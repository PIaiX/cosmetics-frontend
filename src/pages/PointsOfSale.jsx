        ...
        <main className="inner">
            <Container>
                ...
                <section className="mb-8">
                    <h1>Где купить</h1>
                    <img src="/images/where.png" alt="where to buy" className="img-fluid mb-5" />
                    ...
                    <Row xs={1} md={2} lg={3} className="g-4 mb-5">
                        <Col xs={12} md={12}>
                            <div className="fst-italic">Москва,Россия</div>
                        </Col>
                        <Col>
                    ...
                    <Row xs={1} md={2} lg={3} className="g-4 mb-5">
                        <Col xs={12} md={12}>
                            <div className="fst-italic">Санкт-Петербург</div>
                        </Col>
                        <Col>
